...
def main():
    ...
    # Weekly reminder: 09:47 VN (02:47 UTC) T7
    scheduler.add_job(send_weekly_reminder, "cron", hour=2, minute=47, day_of_week="sat")
    # Daily summary: 23:00 VN (16:00 UTC) T2-T7
    scheduler.add_job(send_daily_summary, "cron", hour=16, minute=0, day_of_week="mon-sat")
    scheduler.start()
    logger.info("Scheduler: daily 16:30 VN (T2-T6) / 11:00 VN (T7), weekly 09:47 VN (T7), summary 23:00 VN (T2-T7)")
